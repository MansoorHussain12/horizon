...
// Here we are creating a bank account within our appwrite database
...
export const createBankAccount = async ({
  ...
  try {
    ...
    const bankAccount = await database.createDocument(
      ...
      BANK_COLLECTION_ID!,
      ID.unique(),
      { accessToken, accountId, bankId, fundingSourceUrl, shareableId, userId }
    );
